...
| [Java Stream API Workshop](https://github.com/MashaBorodkina/G56-Stream-Workshop/tree/Maria_B-Stream_Exercise) | Hands-on Stream API practice with 14 tasks: filtering, mapping, collection transformations, advanced stream ops; solutions verified by unit tests. | *Java, Stream API, Lambda Expressions, Collections, JUnit 5* |
